      ...
      <form [formGroup]="form" *ngIf="isLoaded()" [ngSwitch]="isToggle()">
        <a class="it-has-checkbox flex-column">
          <app-control-toggle
            ...
            [label]="'label.jconon_application.fl_decaduto_altro_impiego' | translate" 
...
export class JcononAspectDecadutoAltroImpiegoComponent extends DynamicComponent<Application> {
    constructor(
